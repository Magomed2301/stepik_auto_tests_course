...
def test_first_link_first():
    assert("Congratulations! You have successfully registered!", "Congratulations! You have successfully "
                                                                 "registered!", "NoSuchElementException")
